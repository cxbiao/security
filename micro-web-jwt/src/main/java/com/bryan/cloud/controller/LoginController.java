...
public class LoginController {
    ...
    String oauthServiceUrl = "http://gateway/micro-jwt/oauth/token";
    ...
    public String callback(@RequestParam String code, String state , HttpSession session){
        ...
        ResponseEntity<String> response = restTemplate.exchange(oauthServiceUrl, HttpMethod.POST, entity, String.class);
