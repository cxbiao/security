...
import com.bryan.cloud.service.UserServiceDetail;
...
*
*
  keytool -genkeypair -alias micro-jwt -validity 3650 -keyalg RSA -dname "CN=jwt,OU=jtw,O=jtw,L=zurich,S=zurich,C=CH" -keypass 123456 -keystore micro-jwt.jks -storepass 123456
